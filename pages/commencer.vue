...
<div>
    <h1>Installation</h1>
    <p>Le framework MSFRAMEWORK a quelques exigences système.</p>
    <p>Vous devrez vous assurer que votre serveur répond aux exigences suivantes</p>
    <ul>
        <li>PHP>=7.3</li>
        <li>Extension PHP PDO</li>
        <li>Extension PHP Fileinfo</li>
        <li>Extension PHP PDO</li>
        <li>Extension PHP JSON</li>
    </ul>
    <h2>Installation de MSFramework</h2>
    <p>
        MSFramework utilise Composer pour gérer ses dépendances.
